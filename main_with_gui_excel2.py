...
print("loading encode file MISTER RAMESH ")
...
print("Encode file loaded successfully MISTER RAMESH")
...
root = tk.Tk()
root.title("Face Recognition Attendance System by RAMESH KOUJALAGI pvt.Ltd")
